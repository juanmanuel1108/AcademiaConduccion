...
<form action="{{ route('InsertCita') }}" method="POST" novalidate name="miformulario">
  @csrf
  <div class="container">
    <div class="shadow-lg p-3 mb-5 bg-white rounded" enctype="multipart/form-data">
      <center>
        <h2 class="titulos">Agendar Cita</h2>
      ...
      <div class="form-row">
        ...
        <div class="col-md-4 mb-3">
          ...
          <input type="text" class="form-control" id="validationServer02" name="apellido" placeholder="Apellido"
            required>
          <div class="invalid-feedback">
        ...
        <div class="col-md-4 mb-3">
            ...
            <input type="text" class="form-control" id="validationServer01" name="telefono" placeholder="Telefono"
              required>
            <div class="invalid-feedback">
      ...
      <div class="form-row">
        <div class="col-md-6 mb-2">
            ...
            <input type="text" class="form-control" id="validationServer03" name="email" placeholder="Correo Electronico"
              required>
            <div class="invalid-feedback">
        ...
        <div class="col-md-6 mb-2">
          ...
          @enderror
          <label>Foto</label>
          <input type="file" class="form-control" name="foto" accept=".jpg , .png , .gif" value="{{ asset('Image')}}">
        </div>
      </div>
      ...
      <div class="form-row">
        <div class="col-md-6 mb-2">
          ...
          <input type="date" class="form-control" id="validationServer01" name="fecha" required>
          <div class="invalid-feedback">
        ...
        <div class="col-md-6 mb-2">
            ...
            <input type="time" class="form-control" id="validationServer01" name="hora" required>
            <div class="invalid-feedback">
