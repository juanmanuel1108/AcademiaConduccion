...
<form action="{{ route('InsertarCalificacion') }}" method="POST" novalidate name="miformulario">
  @csrf
  <div class="container">
    <div class="shadow-lg p-3 mb-5 bg-white rounded" enctype="multipart/form-data">
      <center>
        <h2 class="titulos">Realizar Calificacion del Curso</h2>
      ...
      <div class="form-row">
          <div class="col-md-6 mb-2">
              ...
              <input type="text" class="form-control" id="validationServer01" name="telefono" placeholder="Telefono" required>
              <div class="invalid-feedback">
          ...
          <div class="col-md-6 mb-2">
              ...
              <input type="number" class="form-control" id="validationServer03" name="calificacion" placeholder="Calificanos" required>
              <div class="invalid-feedback">
        ...
        <div class="form-row justify-content-center">
          <div class="col-sm-12 sm-1">
              ...
              <input type="text" class="form-control" id="validationServer02" name="opinion" placeholder="Opinion del Curso" required>
              <div class="invalid-feedback">
